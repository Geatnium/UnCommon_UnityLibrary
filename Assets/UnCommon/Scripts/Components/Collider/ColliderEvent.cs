...
/// </summary>
public class ColliderEvent : ChildActorComponentBase, ITag
{
    //---------------------------- パラメータ ----------------------------//
    #region パラメータ
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            targetCollisionEventHandler = ownerParent.gameObject.GetComponent<ICollisionEventHandler>();
        }
        if (targetCollisionEventHandler.IsValid())
        {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            targetTriggerEventHandler = ownerParent.gameObject.GetComponent<ITriggerEventHandler>();
        }
        if (targetTriggerEventHandler.IsValid())
        {
