...
public interface ITriggerEventHandler : IEventSystemHandler
{
    ...
    void OnTriggerOverlapEnter(CollisionEvent ownerCollider, GameObject other, Actor othersActor, Collider hitResult);
    ...
    void OnTriggerOverlapStay(CollisionEvent ownerCollider, GameObject other, Actor othersActor, Collider hitResult);
    ...
    /// <param name="collider">ヒットしたコライダー情報</param>
    void OnTriggerOverlapExit(CollisionEvent ownerCollider, GameObject other, Actor othersActor, Collider hitResult);
}