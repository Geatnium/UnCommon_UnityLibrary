...
namespace UnCommon
{
    ...
    /// <summary>
    /// Widgetの機能提供を行なうためのコンポーネントのベース
    /// </summary>
    public abstract class WidgetComponentBase : ComponentBase, IWidgetComponent
    {
        //---------------------------- パラメータ ----------------------------//
        #region パラメータ
        ...
        {
            ownerWidget = GetComponent<Widget>();
        }

        public virtual void OnFinishedOpen()
        {
        ...
        public virtual void OnFinishedClose()
        {
